...
//verifier la connexion
 ...
 //récupération de l'id dans le lien
  if(isset($_GET['id'])){//si un id a été envoyé alors :
    ...
    $produit = mysqli_query($con ,"SELECT * FROM article WHERE idArticle = $id") ;
    ...
    if(isset($_SESSION['boutique'][$id])){// si le produit est déjà dans le panier
        $_SESSION['boutique'][$id]++; //Représente la quantité 
    }else {
